...
def canonical_affine_first_avoid(n: int, gates: list[Gate]):
    ...
    for i, g in enumerate(gates):
        ...
        try:
            ...
            # A complete canonical target vector is the simplest explicit
            # witness: any preimage would satisfy the already inconsistent
            # canonical affine-hull constraints.
            return tuple(targets), {
                "case": "inconsistent_canonical_hulls",
                "eta": n - full_system.rank,
            }
        if gain > 0:
            full_system = trial
