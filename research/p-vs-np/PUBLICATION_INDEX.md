...
| `v72/V72_BRANCH_RESIDUAL_THEOREM.tex` | three-uniform width NP-completeness, exact subset DP, branch affine residual composition, and bounded-treewidth separation | current candidate; PR CI required, novelty unconfirmed |
...
V72 is currently a standalone extension. It must receive external proof review before being folded into a new consolidated release.
...
- `v72/V73_CORE_CONTEXT.md` — frozen next-step constraints.
...
V72 does not change publication status.
...
- V72 must pass quick, full, and LaTeX pull-request CI before promotion.
