# V111 core context — phase conflict versus nested bottleneck
...
The target question is whether repeated bottlenecks form a provably shrinking dominator chain/decomposition. A promotion-worthy V111 result would need one of:
...
Do not claim all-MUX from V110. Do not promote V111 from only random coverage. Require a symbolic exchange/decomposition theorem, a strict asymptotic separation, or a scalable obstruction.
