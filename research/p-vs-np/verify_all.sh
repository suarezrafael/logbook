...
MODE="quick"
FOCUSED_VERSIONS=(V53 V54 V55 V56 V57 V58 V59 V78 V79 V80 V81 V82 V83 V84 V85 V86 V87 V88 V89 V90 V91 V92)
...
Usage: ./verify_all.sh [--compat|--full|--list]
  ...
  default   Run the focused regression gate for V53-V59 and V78-V92.
