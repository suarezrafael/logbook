...
def main():
    ...
    state=(ROOT/'STATE.md').read_text();assert '**Current laboratory:** V69' in state and 'G*_proj' in state
    ...
    for phrase in ('p versus np is solved','we prove p != np','all instances have a polynomial good order','g*_proj is exponential'):
