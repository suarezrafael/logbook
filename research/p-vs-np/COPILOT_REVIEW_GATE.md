...
3. Request or wait for the GitHub Copilot pull-request review on the current final head SHA.
4. Inspect the review summary, every inline thread, suppressed findings reported in the summary, and top-level comments.
...
8. Mark the PR ready and merge only when:
